<nav class="navbar navbar-light navbar-expand-md py-3" style="background: var(--bs-gray-900);">
    <div class="container"><a class="navbar-brand d-flex align-items-center" href="{{ route('inicio') }}"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><img src="{{url("/images/pagina/GlichCodeLogo.png")}}" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier rounded-circle mx-2" width="50px" height="50px">
